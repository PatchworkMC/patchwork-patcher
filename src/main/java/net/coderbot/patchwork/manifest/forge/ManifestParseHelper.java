...
public class ManifestParseHelper {
	...
	public static Map<String, Object> toMap(Object object, String thing)
			throws ManifestParseException {
	...
	public static List getList(Map<String, Object> data, String key, boolean required)
			throws ManifestParseException {
		Object entry = getEntry(data, key, required);
	...
	public static ManifestParseException typeError(String thing, Object value, String expected) {
		return new ManifestParseException(thing + " was an instance of " +
										  value.getClass().getSimpleName() +
										  " but an instance of " + expected + " was expected!");
	}
}
