...
import net.coderbot.patchwork.generator.BiConsumerGenerator;
...
public class InstanceEventRegistrarGenerator {
	...
	public static String generate(String targetClass,
		...
		BiConsumerGenerator generator = new BiConsumerGenerator(
				visitor, generatedName, targetDescriptor, EVENT_BUS, null, null);
