...
/**
 * Utility class for generalizing access to fields. Can be seen like a wrapper around a TypeMapper for a specific
 * parameter or flag.
 */
class FieldAccessor {
    ...
    /**
     * Constructs a new FieldAccessor with a specified type mapper and some utility parameters for a specified
     * parameter or flag.
     *
     ...
     *
     * @return {@code true} if this parameter is required, {@code false} if not or if we are dealing with a flag
     */
    boolean required() {
        return required;
    }
    ...
    /**
     * Determines wether this parameter or flag has been filled. Might depend on previous used values.
     *
     * @return {@code true} if the parameter or flag has been fully filled already, {@code false} otherwise
     */
    boolean filled() {
