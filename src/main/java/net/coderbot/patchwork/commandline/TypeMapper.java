...
public interface TypeMapper {
    /**
     * Tries to apply the given value to the target. What exactly this does, is implementation defined.
     *
     * @param value The value which should be applied, will be null if {@link TypeMapper#acceptsValue()} is false
