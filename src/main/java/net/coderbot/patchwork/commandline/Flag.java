...
/**
 * Annotation for marking a field as a flag in the type of an object passed to a {@link CommandlineParser}.
 *
...
public @interface Flag {
     ...
     *     <ul>
     *         <li>If <code>name.length() < 2</code>, the name on the commandline will be <code>"-" + name</code></li>
     *         <li>Else the name will be <code>"--" + name</code></li>
     *     </ul>
     * </p>
     *
     * <p>
    ...
    /**
     * A description of what this flag does. Newlines can be freely used, should even be to avoid lines
