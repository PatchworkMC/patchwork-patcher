...
public abstract class BasicTypeMapper<T> implements TypeMapper {
    ...
    // A BasicTypeMapper assumes it has a onetime set field which is fully filled after being set once
    // so we keep track if the field has already been set
     ...
     * @throws CommandlineException If something goes wrong while invoking the setter, for example if the field is
    ...
    /**
     * Checks wether this field has been filled, for a {@link BasicTypeMapper} this will be {@code true} after
