...
public class BooleanTypeMapper extends BasicTypeMapper<Boolean> {
     ...
     * @throws CommandlineException If an error occurs while setting the underlying field to {@code true}
     */
    @Override
    ...
    /**
     * Always returns {@code false} as calling {@link BooleanTypeMapper#apply(String)} expects the value to be
     * {@code null}.
     *
