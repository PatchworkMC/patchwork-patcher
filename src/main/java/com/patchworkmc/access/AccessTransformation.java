...
public class AccessTransformation {
	...
	public static final AccessTransformation DEFINALIZE_MAKE_PUBLIC = new AccessTransformation(Opcodes.ACC_FINAL | Opcodes.ACC_PRIVATE | Opcodes.ACC_PROTECTED, Opcodes.ACC_PUBLIC);
