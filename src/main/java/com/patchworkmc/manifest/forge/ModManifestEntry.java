...
public class ModManifestEntry {
	...
	public String toString() {
		return "ModManifestEntry{" + "modId='" + modId + '\'' + ", version='" + version + '\'' + ", displayName='" + displayName + '\'' + ", description='" + description + '\'' + ", namespace='" + namespace + '\'' + ", logoFile='" + logoFile + '\'' + ", updateJsonUrl='" + updateJsonUrl + '\'' + ", credits='" + credits + '\'' + ", authors='" + authors + '\'' + ", displayUrl='" + displayUrl + '\'' + ", properties=" + properties + '}';
	}
}
