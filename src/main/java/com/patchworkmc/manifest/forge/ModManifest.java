...
public class ModManifest {
	...
	public String toString() {
		return "ModManifest{" + "modLoader='" + modLoader + '\'' + ", loaderVersion='" + loaderVersion + '\'' + ", showAsResourcePack=" + showAsResourcePack + ", properties=" + properties + ", issueTrackerUrl='" + issueTrackerUrl + '\'' + ", logoFile='" + logoFile + '\'' + ", mods=" + mods + ", dependencyMapping=" + dependencyMapping + '}';
	}
}
