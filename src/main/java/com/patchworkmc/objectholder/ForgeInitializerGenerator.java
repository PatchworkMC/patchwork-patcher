...
public class ForgeInitializerGenerator {
	...
	public static void generate(String modName, String className, String modId, List<Map.Entry<String, String>> staticEventRegistrars, List<Map.Entry<String, String>> instanceEventRegistrars, List<Map.Entry<String, EventBusSubscriber>> subscribers, List<Map.Entry<String, ObjectHolder>> objectHolderEntries, ClassVisitor visitor) {
		visitor.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC | Opcodes.ACC_SUPER, className, "Ljava/lang/Object;Lnet/coderbot/patchwork/ForgeInitializer;", "java/lang/Object", new String[] {"com/patchworkmc/ForgeInitializer"});
...

		{
			...
			for (Map.Entry<String, ObjectHolder> entry : objectHolderEntries) {
				...
				method.visitFieldInsn(Opcodes.GETSTATIC, "com/patchworkmc/ObjectHolderRegistry", "INSTANCE", "Lnet/coderbot/patchwork/ObjectHolderRegistry;");
				...
				method.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "com/patchworkmc/ObjectHolderRegistry", "register", "(Lnet/minecraft/class_2378;Ljava/lang/String;Ljava/lang/String;Ljava/util/function/Consumer;)V", false);
			}
