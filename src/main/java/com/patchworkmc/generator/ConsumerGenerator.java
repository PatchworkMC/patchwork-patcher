package com.patchworkmc.generator;
...
/**
 * A utility for generating classes that implement {@link java.util.function.Consumer}.
 */
public class ConsumerGenerator {
	...
	public MethodVisitor visitAccept() {
		return visitor.visitMethod(Opcodes.ACC_PUBLIC, "accept", "(" + descriptor + ")V", signature != null ? "(" + signature + ")V" : null, null);
	}
	...
	public void visitEnd() {
		MethodVisitor method = visitor.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_BRIDGE, "accept", "(Ljava/lang/Object;)V", null, null);
		...
		method.visitMethodInsn(Opcodes.INVOKEVIRTUAL, name, "accept", "(" + descriptor + ")V", false);
