...
public class BiConsumerGenerator {
	...
	public MethodVisitor visitAccept() {
		...
		return visitor.visitMethod(Opcodes.ACC_PUBLIC, "accept", "(" + descriptorA + descriptorB + ")V", signature, null);
	}
	...
	public void visitEnd() {
		MethodVisitor method = visitor.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_BRIDGE, "accept", "(Ljava/lang/Object;Ljava/lang/Object;)V", null, null);
		...
		method.visitMethodInsn(Opcodes.INVOKEVIRTUAL, name, "accept", "(" + descriptorA + descriptorB + ")V", false);
