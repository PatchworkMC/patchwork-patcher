			...
			if ((parameterAnnotation = field.getAnnotation(Parameter.class)) != null) {
				...
				if (parameterAnnotation.position() == -1) {
					if (remainingAccessor != null) {
						...
						remainingAccessor = new FieldAccessor(getTypeMapper(parameterAnnotation.typeMapper(), field), new String[] {
							parameterAnnotation.name() }, parameterAnnotation.description(), parameterAnnotation.required());
					}
				...
				unorderedParameters.put(parameterAnnotation.position(), new FieldAccessor(getTypeMapper(parameterAnnotation.typeMapper(), field), new String[] {
						parameterAnnotation.name() }, parameterAnnotation.description(), parameterAnnotation.required()));
