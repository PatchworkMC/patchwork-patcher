...
public class ManifestParseHelper {
	private static Object getEntry(Map<String, Object> data, String key, boolean required) throws ManifestParseException {
	...
	public static Map<String, Object> getMap(Map<String, Object> data, String key, boolean required) throws ManifestParseException {
		Object entry = getEntry(data, key, required);
